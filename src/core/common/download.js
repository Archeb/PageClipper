...
async function downloadPage(pageData, options) {
	...
	const message = {
		...
		addToPrivateSearchIndex: options.addToPrivateSearchIndex,
		privateSearchURL: options.privateSearchURL,
		privateSearchIndex: options.privateSearchIndex,
		privateSearchToken: options.privateSearchToken,
